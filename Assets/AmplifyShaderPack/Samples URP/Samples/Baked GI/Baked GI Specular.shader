	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float3 SRP_Lambert_Half1362_g8 = localAdditionalLightsHalfLambertMask12x151_g25;
				...
				float3 WorldPosition157_g12 = worldPosValue184_g12;
				...
				float3 WorldNormal157_g12 = worldNormalValue185_g12;
				float3 temp_output_15_0_g12 = WorldViewDirection;
				float3 WorldView157_g12 = temp_output_15_0_g12;
				float3 temp_output_1196_0_g8 = (_IndirectSpecularColor).rgb;
				float3 temp_output_14_0_g12 = temp_output_1196_0_g8;
				float3 SpecColor157_g12 = temp_output_14_0_g12;
				float temp_output_18_0_g12 = _IndirectSpecularSmoothness;
				float Smoothness157_g12 = temp_output_18_0_g12;
				float3 localAdditionalLightsSpecular10x12x157_g12 = AdditionalLightsSpecular10x12x( WorldPosition157_g12 , WorldNormal157_g12 , WorldView157_g12 , SpecColor157_g12 , Smoothness157_g12 );
				...
				float3 temp_output_1202_0_g8 = ( localAdditionalLightsSpecular10x12x157_g12 + temp_output_1192_0_g8 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float3 worldNormalValue185_g25 = worldNormal12_g25;
				float3 WorldNormal151_g25 = worldNormalValue185_g25;
				float2 temp_output_1255_0_g8 = (IN.ase_texcoord4.zw*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float2 UV2Dynamic1251_g8 = temp_output_1255_0_g8;
				half2 LightmapUV1_g23 = UV2Dynamic1251_g8;
				half4 localCalculateShadowMask1_g23 = CalculateShadowMask1_g23( LightmapUV1_g23 );
				float4 shadowMaskValue182_g25 = localCalculateShadowMask1_g23;
...
ASEEND*/
//CHKSM=58C0361DCA97263FF239B5AACB11179CD415110D