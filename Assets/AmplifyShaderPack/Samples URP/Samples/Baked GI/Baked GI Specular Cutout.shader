	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float3 WorldPosition151_g25 = worldPosValue184_g25;
				...
				float3 WorldNormal151_g25 = worldNormalValue185_g25;
				float2 temp_output_1255_0_g15 = (IN.ase_texcoord8.zw*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				...
				float4 ShadowMask151_g25 = shadowMaskValue182_g25;
				float3 localAdditionalLightsHalfLambertMask12x151_g25 = AdditionalLightsHalfLambertMask12x( WorldPosition151_g25 , WorldNormal151_g25 , ShadowMask151_g25 );
				float3 SRP_Lambert_Half1362_g15 = localAdditionalLightsHalfLambertMask12x151_g25;
				...
				float2 temp_output_1219_0_g15 = (IN.ase_texcoord9.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				...
				float3 WorldPosition157_g16 = worldPosValue184_g16;
				...
				float3 WorldNormal157_g16 = worldNormalValue185_g16;
				float3 temp_output_15_0_g16 = WorldViewDirection;
				float3 WorldView157_g16 = temp_output_15_0_g16;
				float3 temp_output_1196_0_g15 = (_IndirectSpecularColor).rgb;
				float3 temp_output_14_0_g16 = temp_output_1196_0_g15;
				float3 SpecColor157_g16 = temp_output_14_0_g16;
				float temp_output_18_0_g16 = _IndirectSpecularSmoothness;
				float Smoothness157_g16 = temp_output_18_0_g16;
				float3 localAdditionalLightsSpecular10x12x157_g16 = AdditionalLightsSpecular10x12x( WorldPosition157_g16 , WorldNormal157_g16 , WorldView157_g16 , SpecColor157_g16 , Smoothness157_g16 );
				...
				float3 temp_output_1202_0_g15 = ( localAdditionalLightsSpecular10x12x157_g16 + temp_output_1192_0_g15 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float3 worldNormalValue185_g25 = worldNormal12_g25;
				float3 WorldNormal151_g25 = worldNormalValue185_g25;
				float2 temp_output_1255_0_g15 = (IN.ase_texcoord4.zw*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float2 UV2Dynamic1251_g15 = temp_output_1255_0_g15;
				half2 LightmapUV1_g23 = UV2Dynamic1251_g15;
				half4 localCalculateShadowMask1_g23 = CalculateShadowMask1_g23( LightmapUV1_g23 );
				float4 shadowMaskValue182_g25 = localCalculateShadowMask1_g23;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 temp_output_133_0_g14 = ( ( IN.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g14 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g14 );
				float MapBaseColorAlpha107_g14 = tex2DNode21_g14.a;
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;33;-160,0;Inherit;False;Material Sample;1;;14;09f1910db887ebd4cb569d6c76c63be3;4,251,0,216,0,263,0,346,1;0;12;FLOAT3;1;FLOAT3;6;FLOAT3;372;FLOAT3;328;FLOAT3;3;FLOAT3;5;FLOAT3;2;FLOAT3;4;FLOAT;8;FLOAT;71;FLOAT;72;FLOAT3;378
...
Node;AmplifyShaderEditor.FunctionNode;34;160,-80;Inherit;False;Material Lighting;40;;15;b5db59747a6f5584db32cde93c4695e4;9,1290,0,1289,0,1288,0,1074,0,1322,0,1323,0,1280,1,1128,1,1378,1;8;898;FLOAT3;0,0,0;False;975;FLOAT3;0,0,1;False;1081;FLOAT;0;False;1079;FLOAT;0;False;1077;FLOAT;0;False;1075;FLOAT;0;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;1;FLOAT3;894
Node;AmplifyShaderEditor.FunctionNode;52;160,272;Inherit;False;Material Baked GI;35;;31;4963945102cd7c746bbe83f48754e7cb;8,910,1,827,1,826,1,838,1,831,1,839,1,1322,0,1323,0;4;975;FLOAT3;0,0,1;False;765;FLOAT3;0,0,1;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;2;FLOAT3;948;FLOAT3;949
...
ASEEND*/
//CHKSM=8F815470533A12D9E8A87643AEEB60260B48DCDC