...
public class LightInterpolator : MonoBehaviour
{
    ...
    {
        LightTime.RegisterLightBlender(this);
    }

    private void OnDisable()
    {
        LightTime.UnregisterLightBlender(this);
    }
...
public class LightInterpolatorEditor : Editor
{
    ...
    private void OnEnable()
    {
        ...
        m_LightTime = GameObject.FindObjectOfType<LightTime>();
        if (m_LightTime != null)
        {
            m_LightTime.Tick(0.0f);
        }
    ...
    void SceneUpdate()
    {
        ...
        m_LightTime.Tick(m_PreviewSlider.value);
